          ...
          <nav className="mt-12">
            <ul className="flex flex-col gap-7 text-lg font-semibold text-white">
              ...
              <a href="#contact">
                <button
                  onClick={() => setShowMenu(false)}
                  className="px-3 py-1 w-max rounded-md bg-blue-500 text-white flex items-center gap-1 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#33CCCC,0_0_15px_#33CCCC,0_0_30px_#33CCCC]  shadow-blue-500 border-blue-400 border-2"
                >
                  Contact
                  <FaChevronRight />
                </button>
